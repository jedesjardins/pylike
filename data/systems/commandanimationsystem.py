...
from data.components import CommandAnimation, Actions, State, Sprite
from engine.ecs.exceptions import NonexistentComponentTypeForEntity
from pygame import Rect

class CommandAnimationSystem(System):
    ...
    def update(self, game):
        ...
        for e, animation in self.entity_manager.pairs_for_type(CommandAnimation):
            try:
